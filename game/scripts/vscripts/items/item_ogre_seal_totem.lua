...
item_ogre_seal_totem = class(ItemBaseClass)
LinkLuaModifier( "modifier_item_ogre_seal_totem", "modifiers/modifier_item_ogre_seal_totem", LUA_MODIFIER_MOTION_BOTH )
...
item_ogre_seal_totem_2 = class(item_ogre_seal_totem)
item_ogre_seal_totem_3 = class(item_ogre_seal_totem)
--------------------------------------------------------------------------------
