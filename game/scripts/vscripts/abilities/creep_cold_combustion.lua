creep_cold_combustion = class( AbilityBaseClass )

LinkLuaModifier( "modifier_creep_cold_combustion", "abilities/creep_cold_combustion.lua", LUA_MODIFIER_MOTION_NONE )
...
function creep_cold_combustion:OnSpellStart()
  Boom(self:GetCaster(), self)
end

function creep_cold_combustion:GetIntrinsicModifierName()
	return "modifier_creep_cold_combustion"
end

--------------------------------------------------------------------------------

modifier_creep_cold_combustion = class( ModifierBaseClass )

--------------------------------------------------------------------------------

function modifier_creep_cold_combustion:IsHidden()
	return true
end

function modifier_creep_cold_combustion:IsDebuff()
	return false
end

function modifier_creep_cold_combustion:IsPurgable()
	return false
end

function modifier_creep_cold_combustion:GetAttributes()
...
if IsServer() then
	function modifier_creep_cold_combustion:DeclareFunctions()
		local funcs = {
...
--------------------------------------------------------------------------------
  ...
  function modifier_creep_cold_combustion:OnDeath( event )
