santa_act3_throw_left = class({})

--------------------------------------------------------------------------------

function santa_act3_throw_left:OnSpellStart()
	...
	Timers:CreateTimer(1.0, function ()
		...
		local throwPos = santa_act3_throw_left:GlobalVectorFromLocal(Vector(100, 600, 0), caster)
...
--
function santa_act3_throw_left:GlobalVectorFromLocal(localVec, entity)
